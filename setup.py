...
package_name = 'ece_148_final_pkg'
...
setup(
    name=package_name,
    version='0.0.0',
    packages=[package_name,submodule,submodule2,submodule3],
    data_files=[
        ...
        (os.path.join('share', package_name, submodule_name2), glob(submodule_name2 + '/*.ini')),
    ...
    entry_points={
        'console_scripts': [
            'ece_148_final = ece_148_final_pkg.ece_148_final:main'
        ],
    },
)
